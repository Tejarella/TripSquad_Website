...
if (isset($_POST['register'])) {
  ...
  mysqli_query($conn,
    "INSERT INTO users VALUES (NULL,'$name','$email','$password',NOW())"
  );
...
<head>
    ...
    <title>Register | TripSquad</title>
    ...
    <div class="flex-1 flex items-center justify-center px-6 mt-20">
        <form method="POST" class="glass-card rounded-3xl p-10 w-full max-w-md">
            ...
            <div class="text-center mb-8">
                <h2 class="text-4xl font-bold text-primary mb-2">Create Account</h2>
                <p class="text-secondary text-lg">Start your journey with TripSquad</p>
            </div>
            ...
            <button type="submit" name="register"
                class="btn-register w-full py-4 rounded-xl font-bold text-lg mt-8">
                Create Account
            </button>
            ...
            <p class="text-center text-secondary">
                ...
                <a href="login.php" class="link-accent font-semibold">Sign in</a>
            </p>
